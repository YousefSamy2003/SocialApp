...
export default function CommentPost({ post }) {
  ...
  <>
              ...
              <div key={post._id} className="flex items-center justify-between text-gray-500">
                ...
                <img
                  src={
                    post.comments[0].commentCreator.photo.includes("undefined")
                      ? "https://media.istockphoto.com/id/1330180806/vector/blue-sign-design-for-photo-placeholder-on-app-design-user-interface-design-avatar-placeholder.jpg?s=612x612&w=0&k=20&c=jMgBjBh-shvWi0ojpkHSMFnTS9vLXFBKws_VLFhK2eo="
